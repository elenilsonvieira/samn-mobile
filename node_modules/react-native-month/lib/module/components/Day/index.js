...
const Day = /*#__PURE__*/React.memo(props => {
  ...
  if (isHidden) {
    return /*#__PURE__*/React.createElement(View, {
      style: [styles.container, theme.hiddenDayContainerStyle]
    });
  }
  ...
  var _prevProps$dots, _nextProps$dots;

  return prevProps.onPress === nextProps.onPress && prevProps.item.isActive === nextProps.item.isActive && prevProps.item.isVisible === nextProps.item.isVisible && prevProps.item.isStartDate === nextProps.item.isStartDate && prevProps.item.isEndDate === nextProps.item.isEndDate && prevProps.renderDayContent === nextProps.renderDayContent && ((_prevProps$dots = prevProps.dots) === null || _prevProps$dots === void 0 ? void 0 : _prevProps$dots.length) === ((_nextProps$dots = nextProps.dots) === null || _nextProps$dots === void 0 ? void 0 : _nextProps$dots.length);
});
export default Day;
