...
const Calendario = /*#__PURE__*/forwardRef((props, ref) => {
  const {
  ...
  const [dynamicLayoutScrollHasHappened, setDynamicLayoutScrollHasHappened] = useState(false);
  ...
  useImperativeHandle(ref, () => listReference.current);
  const {
    months,
  ...
  const handleMonthLayout = useCallback((index, e) => {
  ...
  const renderMonth = useCallback(_ref => {
    let {
      index
    } = _ref;
  ...
  return /*#__PURE__*/React.createElement(FlatList, {
    ...
    initialScrollIndex: props.initialScrollIndex ?? (!isWeb && !calculateMonthHeightDynamically) ? firstMonthIndex : 0,
